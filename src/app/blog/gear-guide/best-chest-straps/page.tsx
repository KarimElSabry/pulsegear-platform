...
const straps = [
  {
    ...
    specs: [
      ...
      { label: "Compatibility", value: "Garmin، Polar، Wahoo، Zwift، كل حاجة" },
    ],
    pros: [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Running Dynamics", value: "✅ Cadence، GCT، Stride، Power" },
      { label: "Memory", value: "بيحفظ بدون Watch" },
    ],
    pros: [
      "Running Dynamics كاملة — Cadence، Ground Contact Time، Stride Length",
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Motion Data", value: "✅ Cadence، Reps، Steps" },
    ],
    pros: [
  ...
  },
  {
    ...
    pros: [
      ...
      "خفيف ومريح",
      "Compatible مع Garmin، Wahoo، Zwift",
    ],
    cons: [
    ...
    verdict:
      "لو بتبدأ وعايز Chest Strap موثوق بأقل سعر ممكن — الـ H9 هو الاختيار الصح. نفس الدقة، أقل Features.",
  },
];
      ...
      <section className="w-full border-b border-zinc-800 py-20 px-6">
        <div className="max-w-3xl mx-auto flex flex-col gap-6">
          ...
          <p className="text-lg text-zinc-400 leading-relaxed">
            ...
            مفيش Bias، مفيش إعلانات — بس الحقيقة. 🎯
          </p>
          ...
          {straps.map((strap) => (
            ...
            >
              ...
              <div className="px-6 py-5 border-b border-zinc-800 flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500">{strap.tagline}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
              ...
              <div className="px-6 py-5 flex items-start gap-3">
                ...
                <p className="text-sm text-zinc-300 leading-relaxed">{strap.verdict}</p>
              </div>
            </div>
          ))}
        </section>
